...
export class BooksellComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog,private registrationService:RegistrationService,private httpClient:HttpClient,private javaService:JavaServiceService) { }
